...
> ## Reminder:
>
> Commit your coding exercises on your Student Workbook for your day-to-day activities.
> This is highly recommended, but not required.
> You can track your own day-to-day learning progress by committing your coding exercises.
> 
...
## Sept-Dec 2026 Schedule

### Sept 3 (Day 1)

- Overview of Front-End Frameworks
  - Reference: (docs/slides/DMIT2008-Week1-Day1-new.pptx)
- Required Tools
   - [X] VS Code
   - [X] git
   - [X] Node (Latest LTS)
   - [X] npm
- Grant access on your Student Workbook Git Repo

### Sept 10 (Day 2)

- Lecture: JS Refresh - Language Fundamentals (docs/slides/DMIT2008-Week1-Day2-new.pptx)
  - Expectations
  - ES5 vs Newer versions of ECMA Script
  - Review
